...
public final class ReservedWords {
    ...
    private static BasicTokenType[] _aeTokenTypes = {
        ...
        BasicTokenType.CALL, BasicTokenType.CDBL, BasicTokenType.CHR, BasicTokenType.CINT, BasicTokenType.CLOSE, BasicTokenType.CLS, BasicTokenType.CMD,
            BasicTokenType.CONT, BasicTokenType.COS,
        BasicTokenType.DATA, BasicTokenType.DEFFN, BasicTokenType.DIM, BasicTokenType.DO,
        BasicTokenType.ELSE, BasicTokenType.END, BasicTokenType.ENDIF, BasicTokenType.ENDWHILE, BasicTokenType.EOF, BasicTokenType.EOL, BasicTokenType.ERL,
            BasicTokenType.ERR, BasicTokenType.EXIT, BasicTokenType.EXP,
        ...
        BasicTokenType.RANDOM, BasicTokenType.READ, BasicTokenType.REM, BasicTokenType.REMAINDER, BasicTokenType.RETURN, BasicTokenType.RIGHT, BasicTokenType.RND,
        BasicTokenType.SIN, BasicTokenType.SQR, BasicTokenType.STEP, BasicTokenType.STOP, BasicTokenType.TOSTRING, BasicTokenType.STR, BasicTokenType.SYSTEM,
        BasicTokenType.TAB, BasicTokenType.TAN, BasicTokenType.THEN, BasicTokenType.TIME, BasicTokenType.TO,
        BasicTokenType.UNTIL,
        BasicTokenType.VAL,
        BasicTokenType.WHILE,
