...
public class Time {
    ...
    public final void parseDateTime(final String strDate) throws Exception {
        ...
        if (strDummy != null) {
            ...
            throw new Exception("[Time] Hour could not been parsed");
        }
        ...
        if (strDummy != null) {
            ...
            throw new Exception("[Time] Minute could not been parsed");
        }
        ...
        if (strDummy != null) {
            ...
            throw new Exception("[Time] Seconds could not been parsed");
        }
    ...
    public final void parseDate(final String strDate) throws Exception {
        ...
        if (strDummy != null) {
            ...
            throw new Exception("[Time] Year could not been parsed");
        }
        ...
        if (strDummy != null) {
            ...
            throw new Exception("[Time] Month could not been parsed");
        }
        ...
        if (strDummy != null) {
            ...
            throw new Exception("[Time] Day could not been parsed");
        }
